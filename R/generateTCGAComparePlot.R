...
#' significant differences between cohorts, ggplot object to show mutation burden comparison
#' @examples
#' library(maftools)
#' library(MAFDash)
...
generateTCGAComparePlot <- function(maf, capture_size = NULL, tcga_capture_size = 35.8, cohortName = NULL, tcga_cohorts = NULL, primarySite = FALSE, col = c('gray70', 'black'), medianCol = 'red', decreasing = FALSE, logscale = TRUE, rm_hyper = FALSE, rm_zero = TRUE){
  ...
  list(median_mutation_burden = tcga.cohort.med, mutation_burden_perSample = tcga.cohort, pairwise_t_test = pt.test.pval,tcga_compare_plot=tcgaComparePlot)
}
