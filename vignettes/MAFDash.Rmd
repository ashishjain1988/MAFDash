...
#plotly::subplot(plotly::subplot(plots$tiTvPatterns,plots$TiTv, nrows = 1, widths = c(1, 0.5)),plots$barplot,nrows = 2)
```
...
```{r eval=TRUE}
filtered_maf <- read.maf(filtered_mafdata, clinicalData = tcga_clinical$annodata)
