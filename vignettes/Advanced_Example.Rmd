...
html_filename=file.path("output/TCGA-UVM.custom.mafdash.html")
...
```
The output can be seen [here](https://mtandon09.github.io/MAFDashRPackage/examples/TCGA-UVM.custom.mafdash.html).
