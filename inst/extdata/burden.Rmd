...
barplotly<-plotly::subplot(plotly::subplot(plotly::style(plots$tiTvPatterns,showlegend = F),plotly::style(plots$TiTv,showlegend = F), nrows = 1, widths = c(0.5, 0.25)),plotly::style(plots$barplot,showlegend = F),nrows = 2) %>% plotly::layout(title = 'Transitions and Transversions plots')
