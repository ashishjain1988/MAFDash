...
barplotly<-plotly::subplot(plotly::subplot(plotly::style(plots$tiTvPatterns,showlegend = F),plotly::style(plots$TiTv,showlegend = F), nrows = 1, widths = c(0.5, 0.25)),plotly::style(plots$barplot,showlegend = F),nrows = 2) %>% plotly::layout(title = 'Transitions and Transversions plots',margin=list(l = 20,r = 20,b = 20,t = 70))

### Use CSS/javascript flex-wrap to contain the two plots
div(
  style = "display: flex; flex-wrap: wrap; justify-content: center",
  div(dotplotly, style = "width: 50%; border: groove;"),
  div(barplotly, style = "width: 50%; border: groove;"),
)
